    ...
    <div class="humberger__menu__wrapper">
      ...
      <nav class="humberger__menu__nav mobile-menu">
        <ul>
          ...
          <li><a href="https://myaccount.google.com/?hl=en">Contact</a></li>
        </ul>
      </nav>
      <div id="mobile-menu-wrap"></div>
      <div class="header__top__right__social">
        <a href="#"><i class="fa fa-facebook"></i></a>
        <a href="https://twitter.com/yummymarket00"><i class="fa fa-twitter"></i></a>
        <a href="#"><i class="fa fa-linkedin"></i></a>

      </div>
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i>yummymarket@gmail.com</li>
   </ul>
      </div>
    </div>
    <!-- Humberger End -->
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Address:casablnca morocco 20000</li>
                <li>Phone:+212 659223613</li>
                <li>Email:yummymarket@gmail.com</li>
              </ul>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-1">
            <div class="footer__widget">
              ...
              <ul>
                ...
                <li><a href="http://127.0.0.1:8000/">Projects</a></li>
                <li><a href="">Contact</a></li>
          ...
          <div class="col-lg-4 col-md-12">
            <div class="footer__widget">
              ...
              <div class="footer__widget__social">
                <a href="https://www.facebook.com/people/yummyMarket/100093001628337/?mibextid=ZbWKwL"><i class="fa fa-facebook"></i></a>
